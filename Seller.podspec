#
#  Be sure to run `pod spec lint Seller.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "GopalHousing22"
  # spec.authors            = { "GopalHousing22" => "108732246+GopalHousing22@users.noreply.github.com" }
  # spec.social_media_url   = "https://twitter.com/GopalHousing22"
